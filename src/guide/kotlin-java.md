...
After minting the assets, you can transfer some of the assets to Joe Carl. To do this, create another user, add the following lines of code to the `main` method
...
In the `sendTransaction` class, add a method to transfer assets
...
In the `Query` class, we implement a wrapper for checking a transaction
