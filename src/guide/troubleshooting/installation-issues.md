...
When you install the Python Wheel package using pip on the "[client setup](/guide/get-started/python#_1-iroha-2-client-setup)" step, you may encounter an error like:
